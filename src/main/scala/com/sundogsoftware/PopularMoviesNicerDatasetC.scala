...
object PopularMoviesNicerDatasetC {
  ...
  def loadMovieNames(): Map[Int, String] = {
    ...
    val linesBufferedSource = Source.fromFile("data/ml-100k/u.item")
    for(line <- linesBufferedSource.getLines()){
